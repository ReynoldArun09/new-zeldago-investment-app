...
<div class="min-h-full p-4 sm:p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        {{-- Total Members --}}
        <div class="bg-white rounded-none p-4 flex items-center gap-4 shadow-sm">
            <div class="w-12 h-12 rounded-none flex items-center justify-center shrink-0 bg-indigo-100">
            ...
            <div class="min-w-0">
                ...
                <p class="text-xl font-bold text-gray-800 mt-0.5">{{ $stats['totalMembers'] }}</p>
            </div>
        </div>

        {{-- Active Members --}}
        <div class="bg-white rounded-none p-4 flex items-center gap-4 shadow-sm">
            <div class="w-12 h-12 rounded-none flex items-center justify-center shrink-0 bg-green-100">
            ...
            <div class="min-w-0">
                <p class="text-xs text-gray-500 truncate">Active Members</p>
                <p class="text-xl font-bold text-gray-800 mt-0.5">{{ $stats['activeMembers'] }}</p>
            </div>
        </div>

        {{-- New Registrations --}}
        <div class="bg-white rounded-none p-4 flex items-center gap-4 shadow-sm">
            <div class="w-12 h-12 rounded-none flex items-center justify-center shrink-0 bg-sky-100">
            ...
            <div class="min-w-0">
                <p class="text-xs text-gray-500 truncate">New Registrations (7d)</p>
                <p class="text-xl font-bold text-gray-800 mt-0.5">{{ $stats['newRegistrations'] }}</p>
            </div>
        </div>

        {{-- Total Business --}}
        <div class="bg-white rounded-none p-4 flex items-center gap-4 shadow-sm">
            <div class="w-12 h-12 rounded-none flex items-center justify-center shrink-0 bg-violet-100">
            ...
            <div class="min-w-0">
                <p class="text-xs text-gray-500 truncate">Total Investments</p>
                <p class="text-xl font-bold text-gray-800 mt-0.5">{{ format_currency($stats['totalBusiness']) }}</p>
            </div>
        </div>

        {{-- Total Income Paid --}}
        <div class="bg-white rounded-none p-4 flex items-center gap-4 shadow-sm">
            <div class="w-12 h-12 rounded-none flex items-center justify-center shrink-0 bg-teal-100">
            ...
            <div class="min-w-0">
                <p class="text-xs text-gray-500 truncate">Total Income Paid</p>
                <p class="text-xl font-bold text-gray-800 mt-0.5">{{ format_currency($stats['totalIncomePaid']) }}</p>
            </div>
        </div>

        {{-- Pending Withdrawals --}}
        <div class="bg-white rounded-none p-4 flex items-center gap-4 shadow-sm">
            <div class="w-12 h-12 rounded-none flex items-center justify-center shrink-0 bg-orange-100">
            ...
            <div class="min-w-0">
                <p class="text-xs text-gray-500 truncate">Pending Withdrawals</p>
                <p class="text-xl font-bold text-gray-800 mt-0.5">{{ $stats['pendingWithdrawals'] }}</p>
            </div>
        </div>

    </div>

    {{-- Withdrawals Mini Cards --}}
    <div class="grid grid-cols-1 gap-4">

        {{-- Withdrawals --}}
        <div class="bg-white rounded-none shadow-sm p-4">
            <h2 class="text-sm font-semibold text-gray-700 mb-3">Withdrawals</h2>
            <div class="grid grid-cols-2 gap-1">
                <div class="flex items-center gap-3 p-3 rounded-none hover:bg-gray-50 cursor-pointer transition-colors group">
                    <div class="w-10 h-10 rounded-none flex items-center justify-center shrink-0 bg-teal-100">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                        </svg>
                    </div>
                    <div class="min-w-0 flex-1">
                        <p class="text-sm font-semibold text-gray-800">{{ format_currency($stats['totalWithdrawn']) }}</p>
                        <p class="text-xs text-gray-500 truncate">Total Withdrawn</p>
                    </div>
                    <span class="text-gray-300 group-hover:text-gray-400">›</span>
                </div>
                <div class="flex items-center gap-3 p-3 rounded-none hover:bg-gray-50 cursor-pointer transition-colors group">
                    <div class="w-10 h-10 rounded-none flex items-center justify-center shrink-0 bg-orange-100">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-sm font-semibold text-gray-800">{{ $stats['pendingWithdrawals'] }}</p>
                        <p class="text-xs text-gray-500 truncate">Pending Withdrawals</p>
                    </div>
                    <span class="text-gray-300 group-hover:text-gray-400">›</span>
                </div>
                <div class="flex items-center gap-3 p-3 rounded-none hover:bg-gray-50 cursor-pointer transition-colors group">
                    <div class="w-10 h-10 rounded-none flex items-center justify-center shrink-0 bg-red-100">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-sm font-semibold text-gray-800">{{ $stats['rejectedWithdrawals'] }}</p>
                        <p class="text-xs text-gray-500 truncate">Rejected Withdrawals</p>
                    </div>
                    <span class="text-gray-300 group-hover:text-gray-400">›</span>
                </div>
                <div class="flex items-center gap-3 p-3 rounded-none hover:bg-gray-50 cursor-pointer transition-colors group">
                    <div class="w-10 h-10 rounded-none flex items-center justify-center shrink-0 bg-violet-100">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-sm font-semibold text-gray-800">{{ format_currency($stats['withdrawalCharge']) }}</p>
                        <p class="text-xs text-gray-500 truncate">Withdrawal Charge</p>
                    </div>
                    <span class="text-gray-300 group-hover:text-gray-400">›</span>
                </div>
            </div>
