...
@section('title', 'Processing ROI Requests (Old)')
...
<div class="w-full">
    ...
    <div class="bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-5 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <h2 class="text-lg font-bold text-gray-800">Processing ROI Requests (Old)</h2>
            <form action="{{ route('admin.old-roi.processing') }}" method="GET" class="flex">
